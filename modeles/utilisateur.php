...
class utilisateur extends Modele {
    ...
    public function getMessages() {
        $sql = 'select date, texte, login, messages.id as idMessage from messages, utilisateurs where messages.auteur=utilisateurs.id and messages.auteur in (select suivi from abonnements where abonne='.$_SESSION['userId'].') order by date';
